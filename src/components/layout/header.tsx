      ...
      <div className="bg-white border-b border-gray-100">
        <div className="container mx-auto flex items-center gap-2 md:gap-4 px-4 h-16">
          ...
          <div className="flex items-center gap-1 md:gap-0.5 ml-auto shrink-0">
            ...
            {/* Same Day — desktop only */}
            <Link
              href={withRef("/category/cakes?slot=same-day")}
              className="hidden lg:flex items-center gap-1 px-3 py-2 text-xs font-medium text-gray-600 hover:text-[#E91E63] transition-colors rounded-lg hover:bg-pink-50"
            >
            ...
            <Link
              href={withRef("/category/gifts?occasion=corporate")}
              className="hidden lg:flex items-center gap-1 px-3 py-2 text-xs font-medium text-gray-600 hover:text-[#E91E63] transition-colors rounded-lg hover:bg-pink-50"
            >
            ...
            {user ? (
              ...
              >
                ...
                <div className="hidden md:flex flex-col items-start">
                  <span className="text-[10px] text-gray-400 leading-none">Hi</span>
                  <span className="text-xs font-semibold text-gray-800 leading-tight">Guest</span>
                </div>
              </Link>
            )}
